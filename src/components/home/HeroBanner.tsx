...
const SLIDES: HeroSlide[] = [
  {
    ...
    description: 'Discover refined styles for every special moment.', cta: 'Shop now',
  ...
  },
  {
    ...
    description: 'Explore beautifully detailed boutique styles designed to make an impression.', cta: 'Explore collection',
  ...
  },
  {
    ...
    description: 'Discover our latest boutique collection.', cta: 'View new arrivals',
